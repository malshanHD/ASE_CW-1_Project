...
<div class="container">
    <div class="row mt-4">
        <div class="col">
        <p class="text-uppercase font-weight-bold text-warning"><span><a class="text-info" href="/">Home</a></span>/<span>Search...</span></p>
        </div>
    </div>
</div>
<div class="container">
    <div class="row mt-3">
        <div class="col">
        <h5 class="font-weight-bold">Search Items</h5>
        </div>
    </div>
</div>
